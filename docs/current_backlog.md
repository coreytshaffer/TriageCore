...
- Operator UX implementation path
  - Source: CR-051, CR-052, CR-053, and CR-054
  - Status: design, template, markdown renderer, and CLI preview command complete; CLI wizard and TUI work remain future slices
