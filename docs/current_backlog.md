...
- Issue #4: Persistent cryptographic agent identities
  ...
  - Current phase: Phase 4 route_audit verification CLI in progress
...
Continue CR-020 in small phases. Phase 4 should remain limited to operator
verification of signed `route_audit` ledger events before any broader
