...
- CR-OC-001A: Mediated Single-File Effect Contract
  - Status: contract merged through PR #119 as `bfa1d6e`; bounded pure-module implementation complete on branch `cr-oc-001a-effect-contract-implementation`, open for review, not merged; runtime integration, persistence, IPC, capability issuance, and CR-OC-001B-E remain unauthorized
