...
## [Unreleased]
- Partially Implemented CR-020 (Persistent Cryptographic Agent Identities): Add the phase 4 `tc audit --verify-signatures` command for signed `route_audit` ledger verification with strict legacy-unsigned enforcement support.
